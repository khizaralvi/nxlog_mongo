...
default['nxlog']['package_source'] = 'https://nexus.disney.com/nexus/content/repositories/ops-global-sedds-yum/disney/dds/misc/nxlog-agent/2.9.1716-1_rhel6.x86_64'
...
when 'rhel'
  ...
  default['nxlog']['log_file'] = '/var/log/nxlog/nxlog.log'
  #default['nxlog']['log_file'] = '/home/local/MGMTPROD/alvik002/nxlog/nxlog.log'
when 'windows'
